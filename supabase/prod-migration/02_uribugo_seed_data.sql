...
-- 생성 시각: 2026-06-04T05:44:11.910Z
...
VALUES ('8c8e6c14-55cf-4644-a3fd-7e0392fc6af6', 'f474a63e-181d-4b1e-a49a-855840ad2484', '근조3단', 'nr-m39', '근조3단 · 근조화환 · Must-have (E2E 테스트용) · rw_menucode=39', NULL, 'https://dauzaeogqwxiwfmvhfux.supabase.co/storage/v1/object/public/products/f474a63e-181d-4b1e-a49a-855840ad2484/temp-1778461204112/1778461203751-ryxlrl.jpg', 100000, 100000, 100, 999, 10, 'active', NULL, '["same_day","quick"]'::jsonb, TRUE, 'category_default', NULL, NULL, '{"rw_menucode":"39","rw_price":"50000","neuron_code":"39","neuron_order_price":"50000"}'::jsonb, '{}'::jsonb, '2026-05-08T07:02:49.249406+00:00'::timestamptz, '2026-06-04T05:44:10.771Z'::timestamptz)
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
...
INSERT INTO public.products (id, partner_id, name, slug, short_description, description_html, thumbnail_url, base_price, sale_price, member_price, stock_qty, safety_stock, status, sticker_options, delivery_methods, allow_delivery_date, policy_source, override_template_id, custom_policy_data, newrun_default_product_draft, newrun_default_option_draft, created_at, updated_at)
VALUES ('bdbc7e6d-8ab2-42b0-971f-d36dc9a70bf0', 'f474a63e-181d-4b1e-a49a-855840ad2484', '축하3단', 'nr-m35', '축하3단 · 축하화환 · Must-have (E2E 테스트용) · rw_menucode=35', NULL, 'https://dauzaeogqwxiwfmvhfux.supabase.co/storage/v1/object/public/products/f474a63e-181d-4b1e-a49a-855840ad2484/temp-1778461171531/1778461171378-2obo0o.jpg', 100000, 100000, 100, 999, 10, 'active', NULL, '["same_day","quick"]'::jsonb, TRUE, 'category_default', NULL, NULL, '{"rw_menucode":"35","rw_price":"50000","neuron_code":"35","neuron_order_price":"50000"}'::jsonb, '{}'::jsonb, '2026-05-08T07:02:49.720462+00:00'::timestamptz, '2026-06-04T05:44:10.772Z'::timestamptz)
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  sale_price = EXCLUDED.sale_price,
  base_price = EXCLUDED.base_price,
...
INSERT INTO public.products (id, partner_id, name, slug, short_description, description_html, thumbnail_url, base_price, sale_price, member_price, stock_qty, safety_stock, status, sticker_options, delivery_methods, allow_delivery_date, policy_source, override_template_id, custom_policy_data, newrun_default_product_draft, newrun_default_option_draft, created_at, updated_at)
VALUES ('1ce0e121-b4e4-4e16-987b-b0cb445de02e', 'f474a63e-181d-4b1e-a49a-855840ad2484', '근조화환(기본형)', 'nr-m09', '근조화환(기본형) · 근조화환 · rw_menucode=09', NULL, 'https://dauzaeogqwxiwfmvhfux.supabase.co/storage/v1/object/public/products/f474a63e-181d-4b1e-a49a-855840ad2484/temp-1778461101061/1778461100950-t9cjgt.jpg', 100000, 100000, 100, 999, 10, 'active', NULL, '["same_day","quick"]'::jsonb, TRUE, 'category_default', NULL, NULL, '{"rw_menucode":"09","rw_price":"50000","neuron_code":"09","neuron_order_price":"50000"}'::jsonb, '{}'::jsonb, '2026-05-08T07:02:50.169975+00:00'::timestamptz, '2026-06-04T05:44:10.772Z'::timestamptz)
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  sale_price = EXCLUDED.sale_price,
  base_price = EXCLUDED.base_price,
...
INSERT INTO public.products (id, partner_id, name, slug, short_description, description_html, thumbnail_url, base_price, sale_price, member_price, stock_qty, safety_stock, status, sticker_options, delivery_methods, allow_delivery_date, policy_source, override_template_id, custom_policy_data, newrun_default_product_draft, newrun_default_option_draft, created_at, updated_at)
VALUES ('e43cecab-82f3-4507-a4b4-94eb78d0534d', 'f474a63e-181d-4b1e-a49a-855840ad2484', '축하화환(기본형)', 'nr-m08', '축하화환(기본형) · 축하화환 · rw_menucode=08', NULL, 'https://dauzaeogqwxiwfmvhfux.supabase.co/storage/v1/object/public/products/f474a63e-181d-4b1e-a49a-855840ad2484/temp-1778461081099/1778461081714-r2abwz.jpg', 100000, 100000, 100, 998, 10, 'active', NULL, '["same_day","quick"]'::jsonb, TRUE, 'category_default', NULL, NULL, '{"rw_menucode":"08","rw_price":"50000","neuron_code":"08","neuron_order_price":"50000"}'::jsonb, '{}'::jsonb, '2026-05-08T07:02:50.626555+00:00'::timestamptz, '2026-06-04T05:44:10.772Z'::timestamptz)
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  sale_price = EXCLUDED.sale_price,
  base_price = EXCLUDED.base_price,
...
INSERT INTO public.products (id, partner_id, name, slug, short_description, description_html, thumbnail_url, base_price, sale_price, member_price, stock_qty, safety_stock, status, sticker_options, delivery_methods, allow_delivery_date, policy_source, override_template_id, custom_policy_data, newrun_default_product_draft, newrun_default_option_draft, created_at, updated_at)
VALUES ('1fce4830-e73f-4826-a3c2-dae1452dc2fb', 'f474a63e-181d-4b1e-a49a-855840ad2484', '근조화환(특)', 'nr-m43', '근조화환(특) · 근조화환 · rw_menucode=43', NULL, 'https://dauzaeogqwxiwfmvhfux.supabase.co/storage/v1/object/public/products/f474a63e-181d-4b1e-a49a-855840ad2484/temp-1778461146795/1778461146561-birrur.jpg', 120000, 120000, 100, 999, 10, 'active', NULL, '["same_day","quick"]'::jsonb, TRUE, 'category_default', NULL, NULL, '{"rw_menucode":"43","rw_price":"70000","neuron_code":"43","neuron_order_price":"70000"}'::jsonb, '{}'::jsonb, '2026-05-08T07:02:51.077344+00:00'::timestamptz, '2026-06-04T05:44:10.772Z'::timestamptz)
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  sale_price = EXCLUDED.sale_price,
  base_price = EXCLUDED.base_price,
...
INSERT INTO public.products (id, partner_id, name, slug, short_description, description_html, thumbnail_url, base_price, sale_price, member_price, stock_qty, safety_stock, status, sticker_options, delivery_methods, allow_delivery_date, policy_source, override_template_id, custom_policy_data, newrun_default_product_draft, newrun_default_option_draft, created_at, updated_at)
VALUES ('7771e6a1-7e11-4ce3-817b-e7c34cb26565', 'f474a63e-181d-4b1e-a49a-855840ad2484', '근조바구니', 'nr-m41', '근조바구니 · 근조화환 · rw_menucode=41', NULL, 'https://dauzaeogqwxiwfmvhfux.supabase.co/storage/v1/object/public/products/f474a63e-181d-4b1e-a49a-855840ad2484/temp-1778224750147/1778224750114-z715mx.jpg', 90000, 90000, 100, 999, 10, 'active', NULL, '["same_day","quick"]'::jsonb, TRUE, 'category_default', NULL, NULL, '{"rw_menucode":"41","rw_price":"50000","neuron_code":"41","neuron_order_price":"50000"}'::jsonb, '{}'::jsonb, '2026-05-08T07:02:52.885414+00:00'::timestamptz, '2026-06-04T05:44:10.773Z'::timestamptz)
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  sale_price = EXCLUDED.sale_price,
  base_price = EXCLUDED.base_price,
...
INSERT INTO public.products (id, partner_id, name, slug, short_description, description_html, thumbnail_url, base_price, sale_price, member_price, stock_qty, safety_stock, status, sticker_options, delivery_methods, allow_delivery_date, policy_source, override_template_id, custom_policy_data, newrun_default_product_draft, newrun_default_option_draft, created_at, updated_at)
VALUES ('d76df1e3-d160-400b-9432-e59678cc51c3', 'f474a63e-181d-4b1e-a49a-855840ad2484', '오브제1단', 'nr-m51', '오브제1단 · 기타 · rw_menucode=51', NULL, 'https://dauzaeogqwxiwfmvhfux.supabase.co/storage/v1/object/public/products/f474a63e-181d-4b1e-a49a-855840ad2484/temp-1778225021539/1778225021497-jv567d.jpg', 120000, 120000, NULL, 988, 10, 'active', NULL, '["same_day","quick"]'::jsonb, TRUE, 'category_default', NULL, NULL, '{"rw_menucode":"51","rw_price":"60000","neuron_code":"51","neuron_order_price":"60000"}'::jsonb, '{}'::jsonb, '2026-05-08T07:02:53.660423+00:00'::timestamptz, '2026-06-04T05:44:10.773Z'::timestamptz)
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  sale_price = EXCLUDED.sale_price,
  base_price = EXCLUDED.base_price,
...
INSERT INTO public.products (id, partner_id, name, slug, short_description, description_html, thumbnail_url, base_price, sale_price, member_price, stock_qty, safety_stock, status, sticker_options, delivery_methods, allow_delivery_date, policy_source, override_template_id, custom_policy_data, newrun_default_product_draft, newrun_default_option_draft, created_at, updated_at)
VALUES ('b1e74752-7a01-4a79-966c-32246deb1b49', 'f474a63e-181d-4b1e-a49a-855840ad2484', '근조쌀화환10kg', 'nr-m91', '근조쌀화환10kg · 근조화환 · rw_menucode=91', NULL, 'https://dauzaeogqwxiwfmvhfux.supabase.co/storage/v1/object/public/products/f474a63e-181d-4b1e-a49a-855840ad2484/temp-1778461283272/1778461283384-mecaly.jpg', 100000, 100000, 100, 963, 10, 'active', NULL, '["same_day","quick"]'::jsonb, TRUE, 'category_default', NULL, NULL, '{"rw_menucode":"91","rw_price":"80000","neuron_code":"91","neuron_order_price":"80000"}'::jsonb, '{}'::jsonb, '2026-05-08T07:02:55.314172+00:00'::timestamptz, '2026-06-04T05:44:10.773Z'::timestamptz)
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  sale_price = EXCLUDED.sale_price,
  base_price = EXCLUDED.base_price,
