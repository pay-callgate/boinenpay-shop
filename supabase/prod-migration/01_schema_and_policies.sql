...
-- ---------- migration: 20260211000003_partners_logo_url.sql.txt ----------
-- =====================================================
-- Migration: partners.logo_url (파트너 CI 로고)
-- Date: 2026-02-11
-- Purpose: 파트너 설정·쇼핑몰 헤더 로고 URL 저장
-- =====================================================
...
-- getaddrinfo ENOENT db.sneelraxnrxylvclopep.supabase.co
