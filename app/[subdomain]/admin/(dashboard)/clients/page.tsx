...
export default function ClientsPage() {
  ...
  const noPartnerAccess = !loading && !!subdomain && partnerId === null;
  ...
  const copyLink = (slug: string) => {
    navigator.clipboard.writeText(getStorefrontUrl(subdomain, slug));
    alert("링크가 복사되었습니다.");
  };
    ...
    <>
      ...
      {show070Modal && selected070Client && (
        <Call070Modal
          ...
          serviceUrl={getStorefrontUrl(subdomain, selected070Client.slug)}
          isOpen={show070Modal}
        ...
        <div className="shrink-0">
          ...
          {noPartnerAccess && (
            <div className="mb-4 rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
              ...
              <p className="mt-1">
                subdomain &quot;{subdomain}&quot;에 해당하는 파트너가 없거나, 현재 로그인한 계정이 해당 파트너의 관리자로 등록되어 있지 않습니다.
                <br />
                <strong>partners</strong> 테이블에 subdomain이 &quot;{subdomain}&quot;인 행이 있는지, <strong>partner_admins</strong> 테이블에 현재 사용자와 해당 파트너의 매핑이 있는지 확인해 주세요.
              </p>
            </div>
          )}
