          ...
          <div className="rounded-lg border border-rose-200/90 bg-gradient-to-br from-rose-50/95 via-white to-amber-50/50 shadow-sm p-6">
            ...
            <div className="mt-6 border-t border-rose-200/60 pt-5">
              ...
              <p className="mt-1 text-xs text-slate-600">
                쇼핑몰 <span className="font-mono">ribbon_message</span> → 뉴런{" "}
                <span className="font-mono">rw_kyungjo</span>, 선택 입력{" "}
                <span className="font-mono">ribbon_card_message</span> →{" "}
                <span className="font-mono">rw_card</span>입니다.
              </p>
